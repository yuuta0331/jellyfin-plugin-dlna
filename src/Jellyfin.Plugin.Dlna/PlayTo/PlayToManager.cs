...
public sealed class PlayToManager : IDisposable
{
    ...
    private async Task AddDevice(UpnpDeviceInfo info, CancellationToken cancellationToken)
    {
        ...
        DlnaPluginLog.Debug(_logger,"Attempting to create PlayToController from location {0}", uri);
    ...
    public void Dispose()
    {
        ...
        {
            DlnaPluginLog.Debug(_logger,ex, "Error while disposing PlayToManager");
        }
